...
plt.legend(handles=[NN1_line,NN2_line,NN3_line,SVM_linear,SVM_gauss,SVM_sigmoid,SVM_poly5,SVM_poly3,SVM_poly2,SVM_poly1,logistic_reg])
plt.plot(x,classifier_data[0],marker='o',color='#97b21e')
...
pickle.dump([NN1,NN2,NN3,SVM_linear,SVM_gauss,SVM_sigmoid,SVM_ploy5,SVM_ploy3,SVM_poly1,logistic_reg], f)
f.close()
